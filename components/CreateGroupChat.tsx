        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[80px] px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-200 resize-none"
            />
          </div>
